   ...
   public CalculatePredictors(String projectName, String issueTracker, String issueTrackerPath,
        ...
        //if(metrics.contains(new Metric("structural scatering"))) {
            ...
            try {
                ...
                Logger.getLogger(it.unisa.gitdm.init.servlet.CalculatePredictors.class.getName()).log(Level.SEVERE, null, ex);
            }
        //}
        ...
        for(Period p : periods) {
                ...
                try {
                    ...
                    pw1.write(writeHeading(metrics, model.getType()));
                    

                    List<FileBean> periodFiles = null;
                    
                    if(model.getType().equals("BugPrediction")) {
                        it.unisa.gitdm.init.servlet.CalculateBuggyFiles cbf = new it.unisa.gitdm.init.servlet.CalculateBuggyFiles(scatteringFolderPath, projectName, issueTracker, issueTrackerPath, productName, false, false, false);
